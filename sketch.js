...
function setup() {
  var canvas = createCanvas(1200,700);
    ...
    box15 = new Box(650,100,50,50);
    box16 = new Box(650,100,50,50);
    box17 = new Box(650,100,50,50);
    box18 = new Box(650,100,50,50);

    box19 = new Box(350,100,50,50);
    box20 = new Box(350,100,50,50);
    box21 = new Box(350,100,50,50);
    box22 = new Box(350,100,50,50);
    box23 = new Box(350,100,50,50);
    box24 = new Box(350,100,50,50);
